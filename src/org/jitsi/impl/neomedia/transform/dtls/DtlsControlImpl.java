    ...
    implements DtlsControl
{
     ...
     * DO WE NEED THIS STILL?  It was a workaround for firefox, maybe no longer
     * necessary?
     */
    ...
    {
		printStack("findHashFunctionUpgrade");
    ...
    {
		printStack("GetLocalFingerprint");
    ...
    {
		printStack("setRemoteFingerprints");
    ...
    private void verifyAndValidateCertificate(
        ...
        throws Exception
    {
		printStack("verifyAndValidateCertificate");
