...
public class SRTPCryptoContextTest
{
    ...
    public static void main(String[] args)
    {
        ...
        RawPacket packet = new RawPacket(test.packetBefore, 0, test.packetBefore.length);
        boolean result = derived.reverseTransformPacket(packet);

        System.out.println("decrypt result: " + result);
        System.out.println("Packet after: length = " + packet.getLength() + ", offset: " + packet.getOffset() + ", " +
                "payload length: " + packet.getPayloadLength() + " payload offset: " + packet.getPayloadOffset() +
                "payload: " + toHex(packet.getPayload()));
//        System.out.println("Packet after: " + toHex(test.packetBefore));
    }
}
